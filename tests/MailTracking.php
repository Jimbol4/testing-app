...
trait MailTracking {
    ...
    protected function seeEmailEquals($body, Swift_Message $message = null) {
        $this->assertEquals($body, $this->getEmail()->getBody(),
    ...
    protected function seeEmailContains($excerpt, Swift_Message $message = null) {
        $this->assertContains($excerpt, $this->getEmail()->getBody(),
                "No email containing the provided body was sent");
        
        return $this;
    }
    
    protected function seeEmailSubjectIs($subject, Swift_Message $message = null) {
        $this->assertEquals($subject, $this->getEmail()->getSubject(),
